...
def jarvis_patrick_clustering():
    ...
    pdf_pages = pdf.PdfPages("plots for jarvis patrick clustering.pdf")

    plt.figure(figsize=(8, 6))
    plt.scatter(x=k_plot,y=smins_plot,c=ari_plot)
    plt.xlabel('k values')
    plt.ylabel('s_min values')
    plt.title('k vs s_min - ARI colored')
    ...
    plt.xlabel('k values')
    plt.ylabel('s_min values')
    plt.title('k vs s_min - SSE colored')
    plt.suptitle('Jarvis Patrick Clustering')
    plt.colorbar()
    plt.grid(True)
    plt.tight_layout()
    ...
    plt.figure(figsize=(8, 6))
    plot_ARI=plt.scatter(data[1000*highest_ari_index:(highest_ari_index+1)*1000, 0], data[1000*highest_ari_index:(highest_ari_index+1)*1000, 1], c=preds_final[highest_ari_index], cmap='viridis')
    ...
    plt.figure(figsize=(8, 6))
    plot_SSE=plt.scatter(data[1000*least_sse_index:(least_sse_index+1)*1000, 0], data[1000*least_sse_index:(least_sse_index+1)*1000, 1], c=preds_final[least_sse_index], cmap='viridis')
